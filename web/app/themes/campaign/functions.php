...
function dcs_metaboxes( array $meta_boxes ) {
	...
	$meta_boxes[] = array(
	    'id' => 'dc_slides',
	    'title' => __('Slide Video Embed', 'designcrumbs'),
	    'pages' => array('slides'), // post type
		'context' => 'normal',
		'priority' => 'high',
		'show_names' => true, // Show field names on the left
	    'fields' => array(
	        array(
		        'name' => __('Video oEmbed Link', 'designcrumbs'),
...
class TestimonialWidget extends WP_Widget
{
  ...
  */
    function TestimonialWidget(){
	    ...
	    parent::__construct('testimonial', __('Testimonial', 'designcrumbs'), $widget_ops, $control_ops);
    }
...
class TextButtonWidget extends WP_Widget
{
  ...
  */
    ...
    $control_ops = array('width' => 300, 'height' => 300);
    parent::__construct('text_button', __('Text with a Button', 'designcrumbs'), $widget_ops, $control_ops);
    }
...
class SlabTextWidget extends WP_Widget
{
  ...
  */
    ...
    $control_ops = array('width' => 300, 'height' => 300);
    parent::__construct('slabtext', __('Slab Text', 'designcrumbs'), $widget_ops, $control_ops);
    }
