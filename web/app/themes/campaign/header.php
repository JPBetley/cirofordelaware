				...
				<div id="main_menu">
					<div class="container">
						...
						<?php if (of_get_option('donate_link') != '') { ?>
							<a id="donate_now" class="button" href="<?php echo stripslashes(of_get_option('donate_link')); ?>" title="<?php echo stripslashes(of_get_option('donate_text')); ?>" target="_blank"><?php echo stripslashes(of_get_option('donate_text')); ?></a>
						<?php } ?>
						</div>
					</div>
				</div>
