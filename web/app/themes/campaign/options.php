...
function optionsframework_options() {
	...
	$options[] = array( "name" => __('Fallback Image', 'designcrumbs'),
						"desc" => __('Upload your fallback image for the home page posts. If the post itself does not have a featured image, this one will be used. The image size should be 170px by 120px. If it\'s larger it will be cropped.', 'designcrumbs'),
	...
	$options[] = array( "name" => __('Instagram', 'designcrumbs'),
						"desc" => __('Enter the URL to your Instagram Profile.', 'designcrumbs'),
						"id" => "instagram",
						"type" => "text");
